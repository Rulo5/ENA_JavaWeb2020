...
<html>
    ...
    <body>
        ...
        <table class="striped pink lighten-4 container">
            ...
            <tbody>
                <tr>
                    ...
                    <td>$0.87</td>
                    <td>$0.87</td>
                    <td><a class="btn deep-purple lighten-1">Cerrar</a></td> 
                </tr>
                <tr>
                    <td>Alan</td>
                    <td>Jellybean</td>
        ...
        <br>
        <div class="center-align">
            <button class="btn waves-effect waves-light purple lighten-3" type="submit" name="VolverAlMenu">Volver al menú
                <i class="material-icons right">send</i>
            </button> 
        </div> 
    </body>
