...
<html>
    ...
    <body>
        <form action="" method="post">
            ...
            <br>
            <div class="center-align">
                <a href ="./MenuPrincipal.jsp" class="btn waves-effect waves-light purple darken-3" type="submit" name="VolverAlMenu">Volver al menú
                    <i class="material-icons right">send</i>
                </a> 
            </div>
        </form>
    ...
    <script>
        function CambiaGerencia(event) {
            ...
            window.location.href = './ConsultaRequerimientos.jsp?gerente=' + event + "&asignar=" + asignar 
        ...
        function cambiarDpto(event) {
            ...
            window.location.href = './ConsultaRequerimientos.jsp?asignar=' + asignar + "&gerente=" + gerente + "&dpto=" + event;
        ...
        function cambiarAsignacion(event) {
            ...
            window.location.href = './ConsultaRequerimientos.jsp?asignar=' + event + "&gerente=" + gerente + "&dpto=" + dpto;
